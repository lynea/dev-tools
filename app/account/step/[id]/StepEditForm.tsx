...
import { stepSchema, stepUpdateSchema } from '@/lib/schema/entityGroup.schema'
...
export const StepEditForm = ({
    ...
    chapters: Chapter[]
    currentStepInfo: z.infer<typeof stepUpdateSchema>
}) => {
    const form = useForm<z.infer<typeof stepSchema>>({
        ...
        defaultValues: {
            ...
            slug: currentStepInfo.slug,
            chapterId: currentStepInfo.chapterId,
            order: currentStepInfo.order,
            videoUrl: currentStepInfo.videoUrl,
        },
    })
    ...
    const onSubmit = async (data: z.infer<typeof stepSchema>) => {
        try {
            ...
            toast(
                'Something went wrong while updating the step. Please try again.'
            )
        }
    }
